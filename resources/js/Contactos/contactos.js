...
$(document).ready(function(){
    ...
    let controlador = "WEB-INF/Controllers/Contactos/ControllerVN.php";
    ...
    $("#GuardarA").click(function(event){
        if ($(form).valid()) {
            ...
            $.post(controlador, {form: $(form).serialize(), "nuevo":nuevoc}).done(function(data) {
                ...
                cambiarContenidos('Contactos/lista_vn.php',id_menu ,id_submenu);
            });    
        }else{
            //alert("VLV")
...
function DatosEditar(IdContactos){
    ...
    let controller = "WEB-INF/Controllers/Contactos/ControllerVN.php";   
...
function FechaF(FechaFf){
    ...
    if(FechaIn!=""){
        ...
        $.post(controller, {"FechaF":"FechaF","FechaI":FechaIn,"FechaFf":FechaFf}).done(function (data) {
            ...
            $( "#datostabla" ).load( "Contactos/lista_vn.php" );
        }); 
    }else{
