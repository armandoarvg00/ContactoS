$(document).ready(function(){
    ...
    let controlador = "WEB-INF/Controllers/Contactos/ControllerC.php";
...
function DatosEditar(IdContactos){
    let controller = "WEB-INF/Controllers/Contactos/ControllerC.php";   
...
function FechaF(FechaFf){
    ...
    if(FechaIn!=""){
        ...
        $.post(controller, {"FechaF":"FechaF","FechaI":FechaIn,"FechaFf":FechaFf}).done(function (data) {
            ...
            $( "#datostabla" ).load( "Contactos/lista_cobranza.php" );
        }); 
    }else{
